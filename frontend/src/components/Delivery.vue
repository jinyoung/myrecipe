<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            <String label="ManualId" v-model="value.manualId" :editMode="editMode"/>
            <Date label="DeliveryDate" v-model="value.deliveryDate" :editMode="editMode"/>
            <String label="DeliveryAddress" v-model="value.deliveryAddress" :editMode="editMode"/>
            <Boolean label="IsDelivered" v-model="value.isDelivered" :editMode="editMode"/>
        </v-card-text>
